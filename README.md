...
27. Moroney, K. M.; O'Connell, K.; Meikle-Janney, T.; O'Brien, S. B. G.; Walker, G. M.; Lee, W. T. "Analysing extraction uniformity from porous coffee beds using mathematical modelling and computational fluid dynamics approaches." *PLoS ONE* 14(7) (2019): e0219906. [https://doi.org/10.1371/journal.pone.0219906](https://doi.org/10.1371/journal.pone.0219906). Author-confirmed errata via Cooper, M. "Modeling Extraction," Quantitative Café (2021), [https://quantitativecafe.com/2021/11/14/modeling-extraction/](https://quantitativecafe.com/2021/11/14/modeling-extraction/). Related cards: [moroney2019](docs/cards/moroney2019.md), [cooper2021](docs/cards/cooper2021.md).
28. Ribes, S. "Radial uniformity of espresso extractions." Slide deck (Decent community), 2020. No DOI is recorded in the model card. Related cards: [ribes2020](docs/cards/ribes2020.md).
29. Ribes, S. "Espresso extraction radial uniformity — BPLUS contact screen." Slide deck (Decent community), 2021. No DOI is recorded in the model card. Related cards: [ribes2021](docs/cards/ribes2021.md).
30. Roman-Corrochano, B.; Melrose, J. R.; Bentley, A. C.; Fryer, P. J.; Bakalis, S. "A new methodology to estimate the steady-state permeability of roast and ground coffee in packed beds." *Journal of Food Engineering* 150 (2015): 106–116. No DOI is recorded in the model card. Related cards: [romancorrochano2015](docs/cards/romancorrochano2015.md).
31. Gagné, J. "A comparison between standard and low-fines espresso shots." Coffee Ad Astra (blog / Patreon), 2021. No DOI is recorded in the model card. Related cards: [gagne2021](docs/cards/gagne2021.md).
32. Khamitova, G. "Advanced experimental and analytical study for the optimization of the espresso coffee extraction." PhD dissertation, University of Camerino, 2020. No DOI is recorded in the model card. Related cards: [khamitova2020](docs/cards/khamitova2020.md).
33. Smrke, S.; Eiermann, A.; Yeretzian, C. "The role of fines in espresso extraction dynamics." *Scientific Reports* 14 (2024): 5612. [https://doi.org/10.1038/s41598-024-55831-x](https://doi.org/10.1038/s41598-024-55831-x). Related cards: [smrke2024](docs/cards/smrke2024.md).
