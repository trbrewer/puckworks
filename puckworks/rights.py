...
# ── non-private permission metadata summaries ─────────────────────────────────────────
# A permission summary is a PUBLIC record: it names the grantor, date, channel and scope, and states that
# the complete correspondence is held privately by the maintainer. It never carries an email address, a
# screenshot/attachment path, or any other contact detail.
_GRUDEVA_PERMISSION = {
    "grantor": "Dr. Yoana Grudeva",
    "grantor_capacity": ("author/maintainer of the upstream reference repository "
                         "github.com/YoanaGrudeva/espresso-model"),
    "recipient": "Tim Brewer (Puckworks repository maintainer)",
    "permission_date": "2026-08-14",
    "channel": "LinkedIn direct message",
    "summary": ("On 2026-08-14, Dr. Yoana Grudeva gave Tim Brewer direct written permission through "
                "LinkedIn to use and share useful material from the upstream espresso-model repository, "
                "expressly confirming that the permission applies to both code and data. The complete "
                "correspondence is retained privately by the repository maintainer."),
    "scope": ("use and sharing of the Grudeva-authored code and data incorporated into Puckworks; the "
              "grantor expressly confirmed the permission covers BOTH code and data"),
    "covered_material": (
        "puckworks/models/grudeva2025/reduced.py — port of the upstream reduced solver (espresso.ipynb)",
        "puckworks/data/grudeva2025/exp13_per_vial_stats.csv — per-vial mean/SD derived from the "
        "upstream exp13.csv",
        "outputs generated by the covered code from the covered data",
    ),
    "output_redistribution_scope": ("accepted for outputs derived from the covered Grudeva code and data "
                                    "only"),
    "formal_license": ("none supplied — this is direct written permission, NOT an SPDX/OSI licence; the "
                       "upstream repository still declares no licence"),
    "spdx_identifier": None,
    "evidence_status": ("complete private correspondence retained by the repository maintainer; NOT "
                        "committed to this repository"),
    "public_record": "docs/permissions/grudeva2025.md",
    "limits": (
        "does not relicense the upstream repository and does not place its content under the Puckworks "
        "MIT licence",
        "does not extend automatically to future upstream files, or to material whose ownership cannot "
        "reasonably be attributed to Dr. Grudeva",
        "does not clear unrelated third-party material",
        "article/thesis-derived material (EJAM, CC-BY) keeps its own separate provenance and is NOT "
        "restated as permission-based",
        "resolves the legal/repository-use block ONLY — evidence strength, validation status, "
        "comparability and validity range are unchanged",
    ),
}
...
# github.com/YoanaGrudeva/espresso-model, which declares NO licence. On 2026-08-14 the upstream author,
# Dr. Yoana Grudeva, gave the maintainer DIRECT WRITTEN PERMISSION (LinkedIn) to use and share both the
# code and the data — so code/data/output are PERMISSION_DOCUMENTED, not CLEAR: permission is on record,
# a formal licence is not. The EJAM article (CC-BY, DOI 10.1017/S095679252500018X) rights remain SEPARATE
# and are not restated as permission-based. No numerics or evidence labels are changed by this record.
...
_RECORDS: dict[str, RightsRecord] = {
    ...
    "grudeva2025.reduced": RightsRecord(
        ...
        data_rights_state="PERMISSION_DOCUMENTED",
        output_redistribution_state="PERMISSION_DOCUMENTED",
        rights_note=(
            "A self-documented direct port of the upstream reference solver "
            "(YoanaGrudeva/espresso-model), which declares no SPDX licence. Direct written permission "
            "from the upstream author, Dr. Yoana Grudeva, dated 2026-08-14 (LinkedIn), covers use and "
            "sharing of BOTH the code and the data; output redistribution is accepted for outputs "
            "derived from that covered code and data. This is PERMISSION_DOCUMENTED, not CLEAR: no "
            "formal licence was supplied, the upstream repository is NOT relicensed, and the material is "
            "NOT placed under the Puckworks MIT licence (see THIRD_PARTY_NOTICES.md). The EJAM article "
            "(CC-BY) licenses the equations/text and is NOT the basis recorded here — article, code, "
            "data and output rights stay tracked separately. Supersedes the 2026-07-18 RIGHTS_BLOCKED "
            "determination, which was correct when made (no permission was then on record). Rights only: "
            "evidence strength, validation status and comparability are unchanged."),
        source=("direct written permission from Dr. Yoana Grudeva to the maintainer, 2026-08-14, LinkedIn "
                "direct message (complete correspondence retained privately; public summary in "
                "docs/permissions/grudeva2025.md); module header self-description ('FAITHFUL PORT ... "
                "rather than re-deriving'); upstream GitHub licence=null; issue #73"),
        decision_issue="#73",
        review_date="2026-08-14",
        permission=_GRUDEVA_PERMISSION),
}
