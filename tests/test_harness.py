...
def test_a8_bedstate_fields():
    ...
    # 0.8 = PressureNode/PressureTrace (third Paper 3 review P0-8); 0.7 = A11 fines-fraction
    # provenance. Both additive, so the A8 BedState fields asserted above are intact.
