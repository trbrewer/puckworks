...
def test_only_publicly_cleared_components_are_offered_and_runnable():
    ...
    # affirmative code and output rights only, including the bounded Wadsworth review.
    assert live == ["brewer2026.lb_reference", "grudeva2025.reduced", "wadsworth2026.permeability"]
