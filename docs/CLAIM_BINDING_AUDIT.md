...
|---|---:|---:|---:|---:|---:|
| Paper 1 | 700 | 187 | **513** | 222 (43.3 %) | **291 (56.7 %)** |
| Paper B2 | 496 | 74 | **422** | 195 (46.2 %) | **227 (53.8 %)** |
| Paper 3 | 376 | 173 | **203** | 136 (67.0 %) | **67 (33.0 %)** |
| **Total** | **1572** | **434** | **1138** | **553 (48.6 %)** | **585 (51.4 %)** |
...
So the 553 verified figure is trustworthy: those resolve through a producer, archive or
...
| input | sha256[:16] |
|---|---|
| `docs/PAPER_A_DRAFT.md` | `0a9790940d1bde09` |
| `docs/submission/PAPER_A_JFE_MANUSCRIPT.md` | `58d253edbb81b635` |
| `docs/PAPER_B2_TEMPORAL_DRAFT.md` | `c2fa8e8908702c40` |
| `docs/PAPER_3_PUCKWORKS_DRAFT.md` | `43c3915b7e148a6b` |
| `puckworks/paper_a/claim_coverage.py` | `143f5898d3e2ad36` |
