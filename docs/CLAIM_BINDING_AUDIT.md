...
|---|---:|---:|---:|---:|---:|
| Paper 1 | 698 | 185 | **513** | 226 (44.1 %) | **287 (55.9 %)** |
| Paper B2 | 496 | 74 | **422** | 195 (46.2 %) | **227 (53.8 %)** |
| Paper 3 | 376 | 173 | **203** | 136 (67.0 %) | **67 (33.0 %)** |
| **Total** | **1570** | **432** | **1138** | **557 (48.9 %)** | **581 (51.1 %)** |
...
|---|---:|
| Registered slow-lane numbers | 104 |
| **Bound to an archive, figure bundle or module constant** | **93** |
...
|---|---:|
| Binding rules defined | 99 |
| Resolving and matching at this commit | 99 |
| Mismatched (drifted) | 0 |
| Unresolvable (archive or field missing) | 0 |
| Rules binding values outside the registered slow-lane set | 6 |
...
Paper 3 is at 67.0 %;
Paper 1 at 44.1 %. The difference is not diligence — it is
...
So the 557 verified figure is trustworthy: those resolve through a producer, archive or
...
| input | sha256[:16] |
|---|---|
| `docs/PAPER_A_DRAFT.md` | `112915dc9fc400a1` |
| `docs/submission/PAPER_A_JFE_MANUSCRIPT.md` | `7b3ebdef5582e6d4` |
| `docs/PAPER_B2_TEMPORAL_DRAFT.md` | `c2fa8e8908702c40` |
| `docs/PAPER_3_PUCKWORKS_DRAFT.md` | `43c3915b7e148a6b` |
| `puckworks/paper_a/claim_coverage.py` | `701f9c13f82ebdd2` |
| `puckworks/paper_a/slow_lane_bindings.py` | `ea0060498cbf422f` |
