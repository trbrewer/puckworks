...
|---|---:|---:|---:|---:|---:|
| Paper 1 | 697 | 188 | **509** | 220 (43.2 %) | **289 (56.8 %)** |
| Paper B2 | 496 | 74 | **422** | 195 (46.2 %) | **227 (53.8 %)** |
| Paper 3 | 376 | 173 | **203** | 136 (67.0 %) | **67 (33.0 %)** |
| **Total** | **1569** | **435** | **1134** | **551 (48.6 %)** | **583 (51.4 %)** |
...
|---|---:|
| Registered slow-lane numbers | 103 |
| **Bound to an archive, figure bundle or module constant** | **92** |
...
|---|---:|
| Binding rules defined | 98 |
| Resolving and matching at this commit | 98 |
...
Paper 3 is at 67.0 %;
Paper 1 at 43.2 %. The difference is not diligence — it is
...
| input | sha256[:16] |
|---|---|
| `docs/PAPER_A_DRAFT.md` | `bc75145cf0b31d40` |
| `docs/submission/PAPER_A_JFE_MANUSCRIPT.md` | `68dd1a9ae4cc9e0b` |
| `docs/PAPER_B2_TEMPORAL_DRAFT.md` | `c2fa8e8908702c40` |
| `docs/PAPER_3_PUCKWORKS_DRAFT.md` | `43c3915b7e148a6b` |
| `puckworks/paper_a/claim_coverage.py` | `826636512f591830` |
| `puckworks/paper_a/slow_lane_bindings.py` | `ed1a6d9295d57747` |
