...
|---|---:|---:|---:|---:|---:|
| Paper 1 | 718 | 189 | **529** | 229 (43.3 %) | **300 (56.7 %)** |
| Paper B2 | 496 | 74 | **422** | 195 (46.2 %) | **227 (53.8 %)** |
| Paper 3 | 376 | 173 | **203** | 136 (67.0 %) | **67 (33.0 %)** |
| **Total** | **1590** | **436** | **1154** | **560 (48.5 %)** | **594 (51.5 %)** |
...
|---|---:|
| Registered slow-lane numbers | 113 |
...
Paper 3 is at 67.0 %;
Paper 1 at 43.3 %. The difference is not diligence — it is
...
So the 560 verified figure is trustworthy: those resolve through a producer, archive or
...
| input | sha256[:16] |
|---|---|
| `docs/PAPER_A_DRAFT.md` | `ada90e11c610c31a` |
| `docs/submission/PAPER_A_JFE_MANUSCRIPT.md` | `3622246d66ee494b` |
| `docs/PAPER_B2_TEMPORAL_DRAFT.md` | `c2fa8e8908702c40` |
| `docs/PAPER_3_PUCKWORKS_DRAFT.md` | `43c3915b7e148a6b` |
| `puckworks/paper_a/claim_coverage.py` | `677ca69687aa4673` |
