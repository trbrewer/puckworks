...
|---|---:|---:|---:|---:|---:|
| Paper 1 | 707 | 185 | **522** | 227 (43.5 %) | **295 (56.5 %)** |
| Paper B2 | 496 | 74 | **422** | 195 (46.2 %) | **227 (53.8 %)** |
| Paper 3 | 376 | 173 | **203** | 136 (67.0 %) | **67 (33.0 %)** |
| **Total** | **1579** | **432** | **1147** | **558 (48.6 %)** | **589 (51.4 %)** |
...
|---|---:|
| Registered slow-lane numbers | 112 |
...
Paper 3 is at 67.0 %;
Paper 1 at 43.5 %. The difference is not diligence — it is
...
So the 558 verified figure is trustworthy: those resolve through a producer, archive or
...
| input | sha256[:16] |
|---|---|
| `docs/PAPER_A_DRAFT.md` | `2c20b857ea37ab71` |
| `docs/submission/PAPER_A_JFE_MANUSCRIPT.md` | `8f56dcb7872f697f` |
| `docs/PAPER_B2_TEMPORAL_DRAFT.md` | `c2fa8e8908702c40` |
| `docs/PAPER_3_PUCKWORKS_DRAFT.md` | `43c3915b7e148a6b` |
| `puckworks/paper_a/claim_coverage.py` | `ea40aacb2783523b` |
