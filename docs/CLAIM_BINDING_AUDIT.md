...
|---|---:|---:|---:|---:|---:|
| Paper 1 | 729 | 193 | **536** | 230 (42.9 %) | **306 (57.1 %)** |
| Paper B2 | 496 | 74 | **422** | 195 (46.2 %) | **227 (53.8 %)** |
| Paper 3 | 376 | 173 | **203** | 136 (67.0 %) | **67 (33.0 %)** |
| **Total** | **1601** | **440** | **1161** | **561 (48.3 %)** | **600 (51.7 %)** |
...
|---|---:|
| Registered slow-lane numbers | 117 |
...
Paper 3 is at 67.0 %;
Paper 1 at 42.9 %. The difference is not diligence — it is
...
So the 561 verified figure is trustworthy: those resolve through a producer, archive or
...
| input | sha256[:16] |
|---|---|
| `docs/PAPER_A_DRAFT.md` | `184273fdb1597292` |
| `docs/submission/PAPER_A_JFE_MANUSCRIPT.md` | `c677e5f0d4905c26` |
| `docs/PAPER_B2_TEMPORAL_DRAFT.md` | `c2fa8e8908702c40` |
| `docs/PAPER_3_PUCKWORKS_DRAFT.md` | `43c3915b7e148a6b` |
| `puckworks/paper_a/claim_coverage.py` | `b8fcd563ceb61794` |
