...
VERDICT: data-only — no model and slide-grade provenance with unknown n, but a three-zone radial EY set (with its sibling `ribes2020`, the registry's two three-zone radial-EY measurements — inlet contact-screen here, outlet paper-filter/tamper there), independently corroborating pocketscience2024's screen/edge findings at finer radial resolution — effort S
