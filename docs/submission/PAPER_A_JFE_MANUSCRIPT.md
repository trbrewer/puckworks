...
**Keywords:** espresso, extraction kinetics, practical identifiability, profile objective, model transfer, experimental design, porous media
...
### 3.3 Pressure → flow map (an assumption, not a fit)
...
deferred — review A-18). So the qualitative conclusion (a large, structured residual not removed by
...
### 3.4 Fitting and evaluation protocol
...
### 3.6 Evidence vocabulary (JFE-standard terms)
