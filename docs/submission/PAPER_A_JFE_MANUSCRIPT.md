...
Whole-cup espresso measurements can be predicted accurately even when a model's
extractable-content and extraction-rate parameters are only weakly separated. We examined this
problem in a multi-solute espresso extraction model previously calibrated to fraction-resolved data
and then recalibrated to optimal-grind whole-cup observations from a different experimental
campaign. Because the source reports beverage mass and the solver terminates on volume, model
predictions were mapped to a 40 mL matched-volume proxy for the reported 40 g endpoint. At each
candidate mass-transfer-rate multiplier, a multiplicative extractable-inventory level was
re-estimated and the resulting objective was profiled. The profile had an interior numerical
minimum, but its 10 %-near-optimal set extended from approximately 0.4 to the upper tested rate
boundary — that is, right-censored by the tested domain — indicating broad inventory–rate
compensation rather than a uniquely localized rate; the pattern persisted across all six
solute × variety panels and three objective families. After optimal-grind calibration, coarse- and
fine-grind predictions had a pooled mean absolute percentage error of 8.2 %, against 8.6 % for an
optimal-grind level-only constant. The paired difference was −0.36 percentage points, with a primary
clustered 95 % resampling interval of −0.73 to +0.03 percentage points, and the mechanistic model was
worse on 50 of 108 held-out points; there was therefore no resolvable improvement over a transferred
...
**Keywords:** espresso, extraction kinetics, extractable content, practical identifiability, profile objective, experimental design
...
value, not a robust mechanistic estimate, and it flips with
...
For the tested multi-solute espresso model and datasets, a matched whole-cup endpoint permits broad compensation between extractable inventory and mass-transfer rate. Internal holdouts and acceptable cross-grind error do not by themselves establish useful kinetic transfer: the mechanistic model added little pooled skill over an optimal-grind level-only constant. Fraction-resolved observations localized the rate more strongly, and an independent time-resolved dissolved-solids trajectory supplied shape information that a single integrated cup could not. These results are specific to the tested model, observation maps, parameter domain, and campaigns, but they establish a practical reporting principle for food-process inverse problems: parameter localization, prediction, benchmark skill, and cross-context transfer should be evaluated and labeled separately. Future experiments should prioritize fraction timing, independently measured inventory, run-level uncertainty, and multi-rig designs that rotate the sensitivity directions of competing parameters.
...
[Insert journal-compliant declaration.]
...
- Bandara, Samuel; Schloder, Johannes P.; Eils, Roland; Bock, Hans Georg; Meyer, Tobias (2009). Optimal experimental design for parameter estimation of a cell signaling model. *PLOS Computational Biology* 5, e1000558. doi:10.1371/journal.pcbi.1000558
...
- Browning, Alexander P.; others (2024). Structural identifiability analysis of linear reaction--advection--diffusion processes in mathematical biology. *Proceedings of the Royal Society A* 480, 20230911. doi:10.1098/rspa.2023.0911
- Brun, Roland; Reichert, Peter; K\"unsch, Hans R. (2001). Practical identifiability analysis of large environmental simulation models. *Water Resources Research* 37, 1015--1030. doi:10.1029/2000WR900350
- Cameron, M. I.; others (2020). Systematically improving espresso: Insights from mathematical modeling and experiment. *Matter* 2, 631--648. doi:10.1016/j.matt.2019.12.019
...
- Giacomini, J.; others (2020). Water flow and transport in porous media for in-silico espresso coffee. *International Journal of Multiphase Flow* 126, 103252. doi:10.1016/j.ijmultiphaseflow.2020.103252
- Gutenkunst, Ryan N.; Waterfall, Joshua J.; Casey, Fergal P.; others (2007). Universally sloppy parameter sensitivities in systems biology models. *PLOS Computational Biology* 3, e189. doi:10.1371/journal.pcbi.0030189
...
- Heinrich, R.; others (2025). On structural and practical identifiability: Current status and update of results. *Current Opinion in Systems Biology* 41, 100546. doi:10.1016/j.coisb.2025.100546
- Lages, N. F.; others (2012). Optimization of time-course experiments for kinetic model discrimination. *PLOS ONE* 7, e32749. doi:10.1371/journal.pone.0032749
...
- Moroney, K. M.; others (2016). Asymptotic analysis of the dominant mechanisms in the coffee extraction process. *SIAM Journal on Applied Mathematics* 76, 2196--2217. doi:10.1137/15M1036658
- Moroney, K. M.; others (2017). Coffee extraction kinetics in a well mixed system. *Journal of Mathematics in Industry* 7, 3. doi:10.1186/s13362-016-0024-6
- Moroney, K. M.; others (2019). Analysing extraction uniformity from porous coffee beds using mathematical modelling and computational fluid dynamics approaches. *PLOS ONE* 14, e0219906. doi:10.1371/journal.pone.0219906
- Navarro-Laboulais, J.; others (2008). Practical identifiability analysis in dynamic gas--liquid reactors: Optimal experimental design for mass-transfer parameters determination. *Computers & Chemical Engineering* 32, 2382--2394. doi:10.1016/j.compchemeng.2007.12.004
- Pannusch, S.; others (2024). Model-based kinetic espresso brewing control chart for representative taste components. *Journal of Food Engineering* 367, 111887. doi:10.1016/j.jfoodeng.2023.111887
- Schmieder, B. K. L.; others (2023). Influence of flow rate, particle size, and temperature on espresso extraction kinetics. *Foods* 12, 2871. doi:10.3390/foods12152871
...
- Vaca Guerra, M.; Harshe, Y. M.; Fries, L.; others (2024). Modeling the extraction of espresso components as dispersed flow through a packed bed. *Journal of Food Engineering* 368, 111913. doi:10.1016/j.jfoodeng.2023.111913
...
- Waszkiewicz, R.; Myck, F.; Bia\las, \L.; Puciata-Mroczynska, M.; Dzikowski, M.; Szymczak, P.; Lisicki, M. (2026). Under pressure: Poroelastic regulation of flow in espresso brewing. *Physics of Fluids* 38, 063113. doi:10.1063/5.0319611
...
- Wieland, F.-G.; Hauber, A. L.; Rosenblatt, M.; Tonsing, C.; Timmer, J. (2021). On structural and practical identifiability. *Current Opinion in Systems Biology* 25, 60--69. doi:10.1016/j.coisb.2021.03.005
