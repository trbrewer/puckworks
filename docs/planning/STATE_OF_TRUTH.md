...
| pv03-flat-valley-interactive | PV-03 'The Cup Hides the Clock' — flat-valley practical-identifiability interactive | public-value | P0 | maintainer | Merge the corrected PV-03 narrative + v0.4.0.dev0 development-line PR, then deliver the generated static interactive (hash-bound Paper A bundle -> PV-03 PublicClaim -> framework-free HTML/CSS/JS with static equivalents), and verify the live GitHub Pages site. | Every headline number is generated from a named function or a hash-bound transform of the Paper A result bundle (no hand-typed numbers); static text + image equivalents; keyboard/screen-reader/reduced-motion accessibility; no external CDN/network/tracking; corrected matched-endpoint story with no stale 25-49% transfer-failure wording; live Pages site verified to show the expected source commit + data-bundle hash. |
