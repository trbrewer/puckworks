...
| pv04-analysis-autopsy | PV-04 'How We Falsified Our Own Espresso Headline' — analysis autopsy | public-value | P0 | maintainer | Build the PV-04 analysis-autopsy interactive (public/pv04-analysis-autopsy): the initially attractive trend, the unit/aggregation error that invalidated the first headline, the corrected raw-replicate contrast, the model's weak interior feature, the model-capacity vs parameter-identification distinction, and the documented revision record — all generated from the existing PV-04 producers. | Queued behind PV-05. Registered PV-04 producer values (raw yields ~18.27/19.38/19.62%, corrected highest-minus-middle contrast ~-0.241 pp, interval ~-0.422..-0.060 pp) reproduce from authoritative analysis functions; deterministic compact schema following PV-03/PV-05; four-scene experience; static equivalents. |
