...
| Ellero & Navarini (illy) | raw direct/inverse transient-discharge point series behind the 2019 overlay + ASIC 1993/1997 scans | request email drafted `docs/sourcing/G2_ELLERO_ASIC_REQUEST_EMAIL.md` (NOT sent; recipient addr unverified) | 2019 figs DIGITIZED (qualitative, `data/ellero2019/`); RAW series still owed | G2 validation (raw series still owed) | digitized 2019 overlay landed (`figure_digitized`, SIM units); request raw ASIC data |
