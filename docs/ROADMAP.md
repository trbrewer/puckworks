...
| Ellero & Navarini (illy) | raw direct/inverse transient-discharge point series behind the 2019 overlay + ASIC 1993/1997 scans | draft in `docs/sourcing/` (not sent) | 2019 figs DIGITIZED (qualitative, `data/ellero2019/`); RAW series still owed | G2 validation (raw series still owed) | digitized 2019 overlay landed (`figure_digitized`, SIM units); request raw ASIC data |
