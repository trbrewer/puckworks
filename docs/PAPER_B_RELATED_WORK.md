...
The two previously flagged publisher records were verified on 2026-07-13; the audit trail
is in `docs/literature_search/DOI_VERIFICATION_2026-07-13.md`. This verification resolves
bibliographic metadata only and does not substitute for the owed indexed novelty search.
...
| waszkiewicz2026 | Waszkiewicz et al., "Under pressure: Poroelastic regulation of flow in espresso brewing," *Phys. Fluids* 38, 063113 (2026) | 10.1063/5.0319611 | **verified 2026-07-13 against AIP publisher record**; supersedes the arXiv-only placeholder |
...
| lee2023 | Lee, Smith & Arshad, "Uneven extraction in coffee brewing," *Phys. Fluids* 35, 054110 (2023) | 10.1063/5.0138998 | **verified 2026-07-13 against AIP publisher record** |
...
| **R2 — null-first κ(t) ladder for the rising-flow residual** | waszkiewicz2026 (poroelastic Φ(t)); foster2025 (machine/infiltration null); fasano2000 I/II (fines migration / compaction); mo2023 (swelling); cameron2020 (dissolution) | We rank these as *nested nulls* on one trace: constant → static-κ(P) → dissolution-Φ(t) → mechanism challengers, and refute the matrix-resistance branches (swelling, fines) **by sign**. The individual mechanisms are the sources'; the null-first ranking + sign refutation is the contribution candidate. |
| **R2 cross-pressure** — within-rig held-out transfer across 11 pressures | waszkiewicz2026 (the 11-pressure campaign + static calibration) | We reuse their campaign and calibration and add a leave-one-pressure-out held-out test of the *discrimination*, not just the static curve. |
...
- **Publisher check complete:** `lee2023` and `waszkiewicz2026` were reconciled
  against their AIP records on 2026-07-13. Preserve the verification memo with the
  search archive and focus PI screening on substantive prior-art overlap.
